    ...
    <div style="margin:0;padding:0;font-family:'Inter','Georgia',serif;color:#3d3d3d;">
      ...
      <div style="max-width:620px;margin:32px auto;padding:40px 28px;border:1px solid #d5d1cb;background:#F8F6F1;">
        ...
        <div style="border:1px solid #c9c4bd;padding:22px 24px;margin-bottom:16px;background:#FFFFFF;">
          ...
          <p style="margin:0 0 20px;font-size:14px;font-weight:400;color:#4a4a4a;">${EVENT_DETAILS.vows.dateLabel}</p>
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
            <tr>
              <td style="width:50%;vertical-align:top;padding-right:12px;">
                <p style="margin:0 0 2px;font-size:15px;font-weight:500;color:#4a4a4a;line-height:1.2;">The Vows</p>
                <p style="margin:0 0 10px;font-size:13px;font-weight:400;color:#6f6f6f;">Exchange of promises</p>
                <p style="margin:0 0 8px;font-size:13px;font-weight:400;color:#555555;">${EVENT_DETAILS.vows.dateLabel}</p>
                <p style="margin:0;font-size:13px;font-weight:400;color:#555555;">${EVENT_DETAILS.vows.timeLabel}</p>
              </td>
              <td style="width:50%;vertical-align:top;padding-left:12px;">
                <p style="margin:0 0 2px;font-size:15px;font-weight:500;color:#4a4a4a;line-height:1.2;">The Celebration</p>
                <p style="margin:0 0 10px;font-size:13px;font-weight:400;color:#6f6f6f;">Exchange of promises</p>
                <p style="margin:0 0 8px;font-size:13px;font-weight:400;color:#555555;">${EVENT_DETAILS.celebration.dateLabel}</p>
                <p style="margin:0;font-size:13px;font-weight:400;color:#555555;">${EVENT_DETAILS.celebration.timeLabel}</p>
              </td>
            </tr>
          </table>
          <p style="margin:24px 0 6px;font-size:11px;letter-spacing:3px;text-transform:uppercase;color:#6f6f6f;">Venue</p>
          <p style="margin:0;font-size:15px;font-weight:500;line-height:1.5;color:#4a4a4a;">${EVENT_DETAILS.venueLabel}</p>
        </div>
